...
--- Output size here ==> image_depth x glimpseDepth , glimpsePatchSize, glimpsePatchSize



--glimpseSensor:add(nn.Collapse(3))
-- imageSize('c') == 1; glimpsePatchSize == 8; glimpseDepth == 1 Output from collapse == vector of size 64
-- add Convolution part here!
glimpseSensor:add(nn.SpatialConvolution(3,10,2,2))
--glimpseSensor:add(nn.SpatialConvolution(10,10,2,2))
--glimpseSensor:add(nn.SpatialConvolution(10,10,2,2))
glimpseSensor:add(nn.Collapse(3))
glimpseSensor:add(nn.Linear(490, opt.glimpseHiddenSize))
